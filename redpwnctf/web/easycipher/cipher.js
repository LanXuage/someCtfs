var _0x29a9 = [
  "\x30\x31\x32\x33\x34\x35\x36\x37\x38\x39\x61\x62\x63\x64\x65\x66", // 0123456789abcdef
  "",
  "\x63\x68\x61\x72\x41\x74", // charAt
  "\x6C\x65\x6E\x67\x74\x68", // length
  "\x63\x68\x61\x72\x43\x6F\x64\x65\x41\x74", // charCodeAt
  "\x57\x68\x61\x74\x20\x69\x73\x20\x74\x68\x65\x20\x70\x61\x73\x73\x77\x6F\x72\x64", // What is the password
...
var hex_chr = _0x29a9[0]; // 0123456789abcdef
function rhex(_0x8e5dx3) {
  str = _0x29a9[1];
  for (j = 0; j <= 3; j++) {
    str +=
      hex_chr[_0x29a9[2]]((_0x8e5dx3 >> (j * 8 + 4)) & 0x0f) +
      hex_chr[_0x29a9[2]]((_0x8e5dx3 >> (j * 8)) & 0x0f);
  }
  return str;
}
...
function cmn(
  ...
  return add(
    rol(add(add(_0x8e5dxf, _0x8e5dxe), add(_0x8e5dx7, _0x8e5dx12)), _0x8e5dx11),
    _0x8e5dx10
  );
}
function ff(
  ...
  return cmn(
    (_0x8e5dx10 & _0x8e5dx14) | (~_0x8e5dx10 & _0x8e5dx15),
    _0x8e5dxf,
    _0x8e5dx10,
    _0x8e5dx7,
    _0x8e5dx11,
...
function gg(
  ...
  return cmn(
    (_0x8e5dx10 & _0x8e5dx15) | (_0x8e5dx14 & ~_0x8e5dx15),
    _0x8e5dxf,
    _0x8e5dx10,
    _0x8e5dx7,
    _0x8e5dx11,
...
function hh(
  ...
  return cmn(
    _0x8e5dx10 ^ _0x8e5dx14 ^ _0x8e5dx15,
    _0x8e5dxf,
    _0x8e5dx10,
    _0x8e5dx7,
    _0x8e5dx11,
...
function ii(
  ...
  return cmn(
    _0x8e5dx14 ^ (_0x8e5dx10 | ~_0x8e5dx15),
    _0x8e5dxf,
    _0x8e5dx10,
    _0x8e5dx7,
    _0x8e5dx11,
...
var tmpp = prompt(_0x29a9[5]);
if (calcMD5(tmpp) === _0x29a9[6]) {
  alert(_0x29a9[7]);
} else {
  alert(calcMD5(tmpp));
  alert(_0x29a9[8]);
